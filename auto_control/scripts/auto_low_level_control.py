...
class ServoConvert():
    def __init__(self, id=1, center_value=300, range=90, direction=1):
        self.value      = 0.0
...
class AutoControl():
    def __init__(self):
        ...
        rospy.init_node('auto_low_level_control')
...
if __name__ == "__main__":
    auto_low_level_control = AutoControl()
    auto_low_level_control.run()
